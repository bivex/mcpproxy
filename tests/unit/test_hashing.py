...
class TestHashing:
    ...
    def test_compute_tool_hash_different_inputs(self):
        ...
        hash3 = compute_tool_hash("tool1", "different desc", base_params)  # Different description
        hash4 = compute_tool_hash("tool1", "description", {"type": "object"})  # Different params
    ...
    def test_compute_tool_hash_unicode_characters(self):
        ...
        params = {"type": "object", "properties": {"名前": {"type": "string"}}}  # Japanese
