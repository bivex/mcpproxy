...
from .schema_fixtures import sample_tool_metadata, sample_tool_metadata_list, sample_search_result, sample_proxy_config
...
# The following fixtures have been moved to tests/fixtures/schema_fixtures.py:
# @pytest.fixture
